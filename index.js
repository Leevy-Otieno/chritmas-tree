(function(){
  ...
  function t(a){
    if(e){
      ...
      gsap.timeline().to(a,{
        ...
        physics2D:{velocity:gsap.utils.random(-25,25),angle:gsap.utils.random(-180,180),gravity:gsap.utils.random(-6,50)},
        scale:0,
  ...
  var e = !0,
      n = "#FFD700 #FFDF00 #DAA520 #FFF8DC #F0E68C #FFE4B5 #FFC107 #FFB300 #FFFFFF".split(" "),
  ...
  var k, m = gsap.utils.random(.6,3.2,.001,!0);
  ...
  (function(){
    ...
    k.to(".pContainer, .sparkle",{duration:6,motionPath:{path:".treePath",autoRotate:!1},ease:"linear"})
     ...
     .from(".treeBottomMask",{duration:2,drawSVG:"0% 0%",stroke:"#FFD700",ease:"linear"},"-=2");
  })();

  c.from([".treePathMask", ".treePotMask"],{drawSVG:"0% 0%",stroke:"#FFD700",stagger:{each:6},duration:gsap.utils.wrap([6,1,2]),ease:"linear"})
